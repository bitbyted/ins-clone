...
import {FormContainer, FormLabel, FormInput, FormButton} from '../Profile/Profile.styles';
        ...
        <FormContainer>
          ...
          <form onSubmit={handleSubmit}>
            <div>
              ...
              <FormInput type='file' id='postLink' name='postLink' onChange={handleImageChange} />
            </div>
            <div>
              <FormLabel htmlFor='caption'>Caption</FormLabel>
              <FormInput type='text' id='caption' name='caption' value={formData.caption} onChange={handleChange} />
            </div>
            <div>
              <FormLabel htmlFor='location'>Location</FormLabel>
              <FormInput type='text' id='location' name='location' value={formData.location} onChange={handleChange} />
            </div>
            <div>
