...
export default function Stories() {
  ...
  const PrevArrow = ({currentSlide, slideCount, ...arrowProps}) => <ArrowBackIosIcon {...arrowProps} />;

  const NextArrow = ({currentSlide, slideCount, ...arrowProps}) => <ArrowForwardIosIcon {...arrowProps} />;
  useEffect(() => {
